...
- Nueva categoría SERVICIOS (grupo bebidas, después de CERVEZA): MICHELADO, CUBANO y CLAMATO PARA CERVEZA con `price: null` listos para asignar precio después; aparece automáticamente en la barra de navegación.
